<div class="leftmenue">
  ...
  <ul class="menu">
    ...
    <li class="left"><a id ="left" href = "index.php">Админка</a></li>
    <li class="left"><a id ="left" href = "blogs.php">Блоги</a></li>
    <li class="left"><a id ="left" href = "users.php">Пользователи</a></li>
    <li class="left"><a id ="left" href = "comments.php">Коментарии</a></li>
    <li class="left"><a id ="left" href = "reviews.php">Отзывы</a></li>
  </ul>
